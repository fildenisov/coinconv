...
/*
DefaultApiService Content Latest
 ...
 * @param optional nil or *DefaultApiGetV1ContentLatestOpts - Optional Parameters:
     ...
     * @param "Id" (optional.String) -  Optional cryptocurrency CoinMarketCap IDs. Example: 1027
     * @param "Slug" (optional.String) -  Alternatively pass one cryptocurrency slug. Example: \&quot;ethereum\&quot;
     * @param "Symbol" (optional.String) -  Alternatively pass one cryptocurrency symbols. Example: \&quot;ETH\&quot;
     * @param "NewsType" (optional.String) -  Optionally specify a comma-separated list of supplemental data fields: &#x60;news&#x60;, &#x60;gravity&#x60;, or &#x60;alexandria&#x60; to filter news sources. Pass &#x60;all&#x60; or leave it blank to include all news types.

@return ContentLatestResponseModel
*/

type DefaultApiGetV1ContentLatestOpts struct { 
...
func (a *DefaultApiService) GetV1ContentLatest(ctx context.Context, localVarOptionals *DefaultApiGetV1ContentLatestOpts) (ContentLatestResponseModel, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ContentLatestResponseModel
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/content/latest"
	...
	if localVarOptionals != nil && localVarOptionals.NewsType.IsSet() {
		localVarQueryParams.Add("news_type", parameterToString(localVarOptionals.NewsType.Value(), ""))
	}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ContentLatestResponseModel
...
/*
DefaultApiService Content Post Comments
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param postId Required post ID. Example: 325670123

@return ContentPostCommentsResponseModel
*/
func (a *DefaultApiService) GetV1ContentPostsComments(ctx context.Context, postId string) (ContentPostCommentsResponseModel, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ContentPostCommentsResponseModel
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/content/posts/comments"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ContentPostCommentsResponseModel
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
DefaultApiService Content Latest Posts
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *DefaultApiGetV1ContentPostsLatestOpts - Optional Parameters:
     * @param "Id" (optional.String) -  Optional one cryptocurrency CoinMarketCap ID. Example: 1027
     * @param "Slug" (optional.String) -  Alternatively pass one cryptocurrency slug. Example: \&quot;ethereum\&quot;
     * @param "Symbol" (optional.String) -  Alternatively pass one cryptocurrency symbols. Example: \&quot;ETH\&quot;
     * @param "LastScore" (optional.String) -  Optional. The score is given in the response for finding next batch posts. Example: 1662903634322

@return ContentLatestPostsResponseModel
*/

type DefaultApiGetV1ContentPostsLatestOpts struct { 
	Id optional.String
	Slug optional.String
	Symbol optional.String
	LastScore optional.String
}

func (a *DefaultApiService) GetV1ContentPostsLatest(ctx context.Context, localVarOptionals *DefaultApiGetV1ContentPostsLatestOpts) (ContentLatestPostsResponseModel, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ContentLatestPostsResponseModel
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/content/posts/latest"
	...
	if localVarOptionals != nil && localVarOptionals.LastScore.IsSet() {
		localVarQueryParams.Add("last_score", parameterToString(localVarOptionals.LastScore.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ContentLatestPostsResponseModel
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
DefaultApiService Content Top Posts
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *DefaultApiGetV1ContentPostsTopOpts - Optional Parameters:
     * @param "Id" (optional.String) -  Optional one cryptocurrency CoinMarketCap ID. Example: 1027
     * @param "Slug" (optional.String) -  Alternatively pass one cryptocurrency slug. Example: \&quot;ethereum\&quot;
     * @param "Symbol" (optional.String) -  Alternatively pass one cryptocurrency symbols. Example: \&quot;ETH\&quot;
     * @param "LastScore" (optional.String) -  Optional. The score is given in the response for finding next batch of related posts. Example: 38507.8865

@return ContentTopPostsResponseModel
*/

type DefaultApiGetV1ContentPostsTopOpts struct { 
	Id optional.String
	Slug optional.String
	Symbol optional.String
	LastScore optional.String
...
func (a *DefaultApiService) GetV1ContentPostsTop(ctx context.Context, localVarOptionals *DefaultApiGetV1ContentPostsTopOpts) (ContentTopPostsResponseModel, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ContentTopPostsResponseModel
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/content/posts/top"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ContentTopPostsResponseModel
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
