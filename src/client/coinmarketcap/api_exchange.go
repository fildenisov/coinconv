 ...
 * @param optional nil or *ExchangeApiGetV1ExchangeInfoOpts - Optional Parameters:
     * @param "Id" (optional.String) -  One or more comma-separated CoinMarketCap cryptocurrency exchange ids. Example: \&quot;1,2\&quot;
     * @param "Slug" (optional.String) -  Alternatively, one or more comma-separated exchange names in URL friendly shorthand \&quot;slug\&quot; format (all lowercase, spaces replaced with hyphens). Example: \&quot;binance,gdax\&quot;. At least one \&quot;id\&quot; *or* \&quot;slug\&quot; is required.
     * @param "Aux" (optional.String) -  Optionally specify a comma-separated list of supplemental data fields to return. Pass &#x60;urls,logo,description,date_launched,notice,status&#x60; to include all auxiliary fields.

@return ExchangesInfoResponseModel
*/

type ExchangeApiGetV1ExchangeInfoOpts struct {
	Id   optional.String
	Slug optional.String
	Aux  optional.String
}

func (a *ExchangeApiService) GetV1ExchangeInfo(ctx context.Context, localVarOptionals *ExchangeApiGetV1ExchangeInfoOpts) (ExchangesInfoResponseModel, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ExchangesInfoResponseModel
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/exchange/info"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ExchangesInfoResponseModel
...
/*
ExchangeApiService Listings Latest
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ExchangeApiGetV1ExchangeListingsLatestOpts - Optional Parameters:
     ...
     * @param "Sort" (optional.String) -  What field to sort the list of exchanges by.
     * @param "SortDir" (optional.String) -  The direction in which to order exchanges against the specified sort.
     * @param "MarketType" (optional.String) -  The type of exchange markets to include in rankings. This field is deprecated. Please use \&quot;all\&quot; for accurate sorting.
     * @param "Category" (optional.String) -  The category for this exchange.
     * @param "Aux" (optional.String) -  Optionally specify a comma-separated list of supplemental data fields to return. Pass &#x60;num_market_pairs,traffic_score,rank,exchange_score,effective_liquidity_24h,date_launched,fiats&#x60; to include all auxiliary fields.
...
@return ExchangeListingsLatestResponseModel
*/

type ExchangeApiGetV1ExchangeListingsLatestOpts struct {
	Start      optional.Int32
	Limit      optional.Int32
	Sort       optional.String
	SortDir    optional.String
	MarketType optional.String
...
func (a *ExchangeApiService) GetV1ExchangeListingsLatest(ctx context.Context, localVarOptionals *ExchangeApiGetV1ExchangeListingsLatestOpts) (ExchangeListingsLatestResponseModel, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ExchangeListingsLatestResponseModel
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/exchange/listings/latest"
	...
	if localVarOptionals != nil && localVarOptionals.MarketType.IsSet() {
		localVarQueryParams.Add("market_type", parameterToString(localVarOptionals.MarketType.Value(), ""))
	}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ExchangeListingsLatestResponseModel
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
ExchangeApiService CoinMarketCap ID Map
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ExchangeApiGetV1ExchangeMapOpts - Optional Parameters:
     * @param "ListingStatus" (optional.String) -  Only active exchanges are returned by default. Pass &#x60;inactive&#x60; to get a list of exchanges that are no longer active. Pass &#x60;untracked&#x60; to get a list of exchanges that are registered but do not currently meet methodology requirements to have active markets tracked. You may pass one or more comma-separated values.
     * @param "Slug" (optional.String) -  Optionally pass a comma-separated list of exchange slugs (lowercase URL friendly shorthand name with spaces replaced with dashes) to return CoinMarketCap IDs for. If this option is passed, other options will be ignored.
     * @param "Start" (optional.Int32) -  Optionally offset the start (1-based index) of the paginated list of items to return.
     * @param "Limit" (optional.Int32) -  Optionally specify the number of results to return. Use this parameter and the \&quot;start\&quot; parameter to determine your own pagination size.
     * @param "Sort" (optional.String) -  What field to sort the list of exchanges by.
     * @param "Aux" (optional.String) -  Optionally specify a comma-separated list of supplemental data fields to return. Pass &#x60;first_historical_data,last_historical_data,is_active,status&#x60; to include all auxiliary fields.
     * @param "CryptoId" (optional.String) -  Optionally include one fiat or cryptocurrency IDs to filter market pairs by. For example &#x60;?crypto_id&#x3D;1&#x60; would only return exchanges that have BTC.

@return ExchangeMapResponseModel
*/

type ExchangeApiGetV1ExchangeMapOpts struct {
	...
	Sort          optional.String
	Aux           optional.String
	CryptoId      optional.String
}

func (a *ExchangeApiService) GetV1ExchangeMap(ctx context.Context, localVarOptionals *ExchangeApiGetV1ExchangeMapOpts) (ExchangeMapResponseModel, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ExchangeMapResponseModel
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/exchange/map"
	...
	if localVarOptionals != nil && localVarOptionals.CryptoId.IsSet() {
		localVarQueryParams.Add("crypto_id", parameterToString(localVarOptionals.CryptoId.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ExchangeMapResponseModel
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
ExchangeApiService Market Pairs Latest
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ExchangeApiGetV1ExchangeMarketpairsLatestOpts - Optional Parameters:
     * @param "Id" (optional.String) -  A CoinMarketCap exchange ID. Example: \&quot;1\&quot;
     * @param "Slug" (optional.String) -  Alternatively pass an exchange \&quot;slug\&quot; (URL friendly all lowercase shorthand version of name with spaces replaced with hyphens). Example: \&quot;binance\&quot;. One \&quot;id\&quot; *or* \&quot;slug\&quot; is required.
     * @param "Start" (optional.Int32) -  Optionally offset the start (1-based index) of the paginated list of items to return.
     * @param "Limit" (optional.Int32) -  Optionally specify the number of results to return. Use this parameter and the \&quot;start\&quot; parameter to determine your own pagination size.
     * @param "Aux" (optional.String) -  Optionally specify a comma-separated list of supplemental data fields to return. Pass &#x60;num_market_pairs,category,fee_type,market_url,currency_name,currency_slug,price_quote,effective_liquidity,market_score,market_reputation&#x60; to include all auxiliary fields.
     * @param "MatchedId" (optional.String) -  Optionally include one or more comma-delimited fiat or cryptocurrency IDs to filter market pairs by. For example &#x60;?matched_id&#x3D;2781&#x60; would only return BTC markets that matched: \&quot;BTC/USD\&quot; or \&quot;USD/BTC\&quot; for the requested exchange. This parameter cannot be used when &#x60;matched_symbol&#x60; is used.
     * @param "MatchedSymbol" (optional.String) -  Optionally include one or more comma-delimited fiat or cryptocurrency symbols to filter market pairs by. For example &#x60;?matched_symbol&#x3D;USD&#x60; would only return BTC markets that matched: \&quot;BTC/USD\&quot; or \&quot;USD/BTC\&quot; for the requested exchange. This parameter cannot be used when &#x60;matched_id&#x60; is used.
...
@return ExchangeMarketPairsLatestResponseModel
*/

type ExchangeApiGetV1ExchangeMarketpairsLatestOpts struct {
	Id            optional.String
	Slug          optional.String
	Start         optional.Int32
	Limit         optional.Int32
...
func (a *ExchangeApiService) GetV1ExchangeMarketpairsLatest(ctx context.Context, localVarOptionals *ExchangeApiGetV1ExchangeMarketpairsLatestOpts) (ExchangeMarketPairsLatestResponseModel, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ExchangeMarketPairsLatestResponseModel
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/exchange/market-pairs/latest"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ExchangeMarketPairsLatestResponseModel
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
ExchangeApiService Quotes Historical
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ExchangeApiGetV1ExchangeQuotesHistoricalOpts - Optional Parameters:
     * @param "Id" (optional.String) -  One or more comma-separated exchange CoinMarketCap ids. Example: \&quot;24,270\&quot;
     * @param "Slug" (optional.String) -  Alternatively, one or more comma-separated exchange names in URL friendly shorthand \&quot;slug\&quot; format (all lowercase, spaces replaced with hyphens). Example: \&quot;binance,kraken\&quot;. At least one \&quot;id\&quot; *or* \&quot;slug\&quot; is required.
...
@return ExchangeHistoricalQuotesResponseModel
*/

type ExchangeApiGetV1ExchangeQuotesHistoricalOpts struct {
	Id        optional.String
	Slug      optional.String
...
func (a *ExchangeApiService) GetV1ExchangeQuotesHistorical(ctx context.Context, localVarOptionals *ExchangeApiGetV1ExchangeQuotesHistoricalOpts) (ExchangeHistoricalQuotesResponseModel, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ExchangeHistoricalQuotesResponseModel
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/exchange/quotes/historical"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ExchangeHistoricalQuotesResponseModel
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
ExchangeApiService Quotes Latest
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ExchangeApiGetV1ExchangeQuotesLatestOpts - Optional Parameters:
     * @param "Id" (optional.String) -  One or more comma-separated CoinMarketCap exchange IDs. Example: \&quot;1,2\&quot;
     * @param "Slug" (optional.String) -  Alternatively, pass a comma-separated list of exchange \&quot;slugs\&quot; (URL friendly all lowercase shorthand version of name with spaces replaced with hyphens). Example: \&quot;binance,gdax\&quot;. At least one \&quot;id\&quot; *or* \&quot;slug\&quot; is required.
     * @param "Convert" (optional.String) -  Optionally calculate market quotes in up to 120 currencies at once by passing a comma-separated list of cryptocurrency or fiat currency symbols. Each additional convert option beyond the first requires an additional call credit. A list of supported fiat options can be found [here](#section/Standards-and-Conventions). Each conversion is returned in its own \&quot;quote\&quot; object.
     * @param "ConvertId" (optional.String) -  Optionally calculate market quotes by CoinMarketCap ID instead of symbol. This option is identical to &#x60;convert&#x60; outside of ID format. Ex: convert_id&#x3D;1,2781 would replace convert&#x3D;BTC,USD in your query. This parameter cannot be used when &#x60;convert&#x60; is used.
     * @param "Aux" (optional.String) -  Optionally specify a comma-separated list of supplemental data fields to return. Pass &#x60;num_market_pairs,traffic_score,rank,exchange_score,liquidity_score,effective_liquidity_24h&#x60; to include all auxiliary fields.

@return ExchangeQuotesLatestResponseModel
*/

type ExchangeApiGetV1ExchangeQuotesLatestOpts struct {
	Id        optional.String
	Slug      optional.String
	Convert   optional.String
	ConvertId optional.String
...
func (a *ExchangeApiService) GetV1ExchangeQuotesLatest(ctx context.Context, localVarOptionals *ExchangeApiGetV1ExchangeQuotesLatestOpts) (ExchangeQuotesLatestResponseModel, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ExchangeQuotesLatestResponseModel
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/exchange/quotes/latest"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ExchangeQuotesLatestResponseModel
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
